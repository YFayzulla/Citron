            ...
            <table class="table table-hover m-1">
                ...
                @foreach($galleries as $gallery)
                    <tr>
                        ...
                        <th>
                            <a href="{{route('gallery.edit',$gallery->id)}}" type="button" class="btn btn-outline-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
